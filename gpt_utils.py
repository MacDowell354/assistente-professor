...
# -----------------------------
# RESPOSTAS CANÔNICAS PARA 5 PERGUNTAS DO GUIA E 5 DO PLANO DE AÇÃO
# -----------------------------
CANONICAL_QA = {
    # GUia do Curso
    ...
    "na parte de autoconfiança profissional, o que devo escrever como atitude para não deixar mais certas situações me abalar?": (
        "Liste duas experiências que abalaram sua confiança. Em “Onde quero chegar”, defina uma atitude transformadora, por exemplo: "
...
def generate_answer(question: str, context: str = "", history: str = None) -> str:
    ...
    # montagem do prompt e chamada ao cliente OpenAI...
