...
def generate_answer(
    ...
    prompt_variacoes = {
        ...
        'aplicacao': (
            ...
            '➡ **Abertura da Consulta:** Garante acolhimento profissional, transmitindo exclusividade e empatia.<br>'
        ...
        'capitacao_sem_marketing_digital': (
            ...
            '➡ **Encantamento de pacientes atuais:** Envie um convite VIP impresso para um evento exclusivo ou um bilhete manuscrito, demonstrando atenção a detalhes pessoais;<br>'
            ...
            '➡ **Construção de autoridade silenciosa:** Colete depoimentos reais e imprima-os em folhetos na recepção; compartilhe cases de sucesso em eventos locais;<br>'
            ...
            'Com essa sequência — que foca em relacionamento, reciprocidade e autoridade real — você **dobra seu faturamento** e conquista pacientes de alto valor **sem depender de redes sociais ou anúncios**.'
        ),
        'precificacao': (
