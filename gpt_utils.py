...
CANONICAL_QA = {
    ...
    "como implementar a acao 1 de networking descrita no dossie 007":
        "Identifique outros profissionais que atendem seus pacientes e envie um áudio de até 40s: 'Oi |Nome|, aqui é o Dr. |Seu Nome|. Podemos conversar 10 minutos sobre o paciente X? Horário: Xh ou Yh?' fileciteturn29file5",
    ...
    "onde encontro o link do formulario para criar no canva o health plan personalizado para o paciente":
        ...
        "<a href=\"https://www.canva.com/design/DAEteeUPSUQ/0isBewvgUTJF0gZaRYZw2g/view?utm_content=DAEteeUPSUQ&utm_campaign=designshare&utm_medium=link&utm_source=publishsharelink&mode=preview\" target=\"_blank\">Formulário Health Plan (Canva)</a>.<br>"
