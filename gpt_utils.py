...
def generate_answer(question: str, context: str = "", history: list = None) -> str:
    ...
    "Sua missão é extrair da transcrição dos módulos do curso consultório High Ticket todas as informações necessárias para responder com clareza, objetividade e didatismo. "
